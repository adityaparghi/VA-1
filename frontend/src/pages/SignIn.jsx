...
function SignIn() {
    ...
    return (
        ...
        flex flex-col justify-center items-center gap-[20px] px-6' onSubmit={handleSignIn}>
                ...
                <button className='min-w-[150px] h-[60px] bg-blue-700 text-white rounded-4xl text-[19px] mt-[5px] cursor-pointer' disabled={loading}>{loading ? "Loading..." : "Sign In"}</button>

                <p className='text-white cursor-pointer text-[17px]' onClick={() => navigate('/signup')}>Create a new account ? <span
